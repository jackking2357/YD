 ...
 */
export function get${entity}Detail (<#list table.fields as field><#if field.keyFlag>${field.propertyName}</#if></#list>) {
  return request({
    url: `${cfg.requestProjectPath}/<#if package.ModuleName??>${package.ModuleName}</#if>/<#if controllerMappingHyphenStyle??>${controllerMappingHyphen}<#else>${table.entityPath}</#if>/get${entity}Detail/${'$'}{<#list table.fields as field><#if field.keyFlag>${field.propertyName}</#if></#list>}`,
    method: 'get'
  })
}
 ...
 * @param {Object} data 携带的数据
 */
export function ${entity?uncap_first}Add (data = {}) {
  return request({
 ...
 * @param {Object} data 携带的数据
 */
export function ${entity?uncap_first}Edit (data = {}) {
  return request({
 ...
 */
export function ${entity?uncap_first}Remove (<#list table.fields as field><#if field.keyFlag>${field.propertyName}</#if></#list>s) {
  return request({
 ...
 * @param {Object} data 携带的数据
 */
export function ${entity?uncap_first}Export( data = {}) {
  return request({
